...
extern int ZEXPORT unzGetGlobalInfo(unzFile file, kk_unz_global_info *pglobal_info);
...
typedef int (*unzIteratorFunction2)(unzFile file, kk_unz_file_info64 *pfile_info, char *filename,
    uint16_t filename_size, void *extrafield, uint16_t extrafield_size, char *comment, uint16_t comment_size);
